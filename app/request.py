...
def get_news_source():
    ...
    get_news_url = 'https://newsapi.org/v2/sources?apiKey=d0054354f7a3447581e739eb8be8abd4'
...
def get_article(id):
    get_article_url = 'https://newsapi.org/v2/top-headlines?sources={}&apiKey=d0054354f7a3447581e739eb8be8abd4'.format(id)
...
def get_articles_category(category):
    ...
    Function that gets the json response to our url request
    '''
    get_articles_url = 'https://newsapi.org/v2/top-headlines?category={}&apiKey=d0054354f7a3447581e739eb8be8abd4'.format(
        category)
